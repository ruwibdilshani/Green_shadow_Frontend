...
$(document).ready(function() {
    ...
    $(".search-bar").on("keyup", function () {
        ...
        $(".table .table-body > div").each(function () {
            ...
            const equName = $(this).children(":nth-child(2)").text();
            const equType = $(this).children(":nth-child(3)").text();
            if (
                equId.includes(searchValue) ||
                equName.includes(searchValue) ||
                equType.includes(searchValue)
            ) {
                $(this).show();
            } else {
                $(this).hide();
