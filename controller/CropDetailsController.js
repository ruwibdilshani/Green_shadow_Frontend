...
$("#update-log-popup button").click(function () {
  ...
  updateCropDetails(targetLogCode, formData)
    .then((data) => {
...
function loadDataToViewPopup() {
  getCropDetails(targetLogCode)
    .then((data) => {
      ...
      $("#view-log-popup .observed-image").attr(
        "src",
        base64ToImageURL(data.observedImage)
      );
